...
<html lang="en">
  <head>
    <%@ include file="header.jsp" %>
     <title>优惠促销</title>
      <link rel="stylesheet" type="text/css" href="statics/assets/bootstrap-switch/static/stylesheets/bootstrap-switch.css"/>
  </head>
  <body>
                   ...
                   <c:if test="${page == null || page.datas == null || page.datas.size() == 0}">
                          ...
                          <div class="row">
                              ...
                              <div class="col-lg-8 c757575">
                                  ...
                                  <button type="button" onclick="toCreate(<c:if test="${!empty restaurantId}">${restaurantId}</c:if>)" class="btn btn-success mg-b-10">
                                      <a href="#" class="cfff">
