                      ...
                      <section class="panel">
                          <div class="panel-body">
                                  <div class="form-group">
                                      ...
                                      <input type="email" class="form-control" id="email" placeholder="" value='<c:if test="${user != null && user.email != null }">${user.email}</c:if>' readonly>
                                  </div>
                                  <div class="form-group">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <c:if test="${restaurantInfo != null && restaurantInfo.resultList != null }">
									        <c:forEach var="item" items="${restaurantInfo.resultList}" >
									            <div class="checkbox">
	                                              <label>
	                                                 ${item.restaurantName}
	                                              </label>
                                  ...
                                  <a href="loginServlet?action=toUpdate&id=${restaurantId}">取消</a>
              		...
              		success : function (data) {
              			...
              			if (data.resultCode != 1) {
              				...
              				if (password != null && password != "") {
              					...
              					setTimeout(function(){
        			                //这里的代码将在1000ms(1s后执行)
              						window.location.href = "userServlet?action=loginOut";
            					},2000);
              					return;
              				} else {
              					toastr["success"]("修改成功！");
